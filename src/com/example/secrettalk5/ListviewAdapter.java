...
public class ListviewAdapter extends BaseAdapter {
	...
	CharSequence[] title ={"回到首頁", "程式導覽", "成就系統介紹","公告", "關於本程式","登出", "結束程式"};
	...
	int[] iconName = {R.drawable.list_home,R.drawable.list_navi,R.drawable.list_achiment,R.drawable.list_navi,R.drawable.list_about,R.drawable.list_signout,R.drawable.list_leave};
	Context context2;  
